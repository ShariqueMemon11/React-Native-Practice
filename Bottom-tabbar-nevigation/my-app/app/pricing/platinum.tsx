  ...
  return (
    <View style={styles.maincontainer}>
      ...
      <View style={styles.pricingcon}>
        ...
        {showchangeprice
        ? <Text style={{color:'white' , fontSize:18}}>28.99 $ /Monthly</Text>
      ...
      <View style={styles.pricingcon2}>
        ...
        {showchangeprice
        ? <Text style={{color:'white' , fontSize:18}}>50.99 $ /Monthly</Text>
        : <Text style={{color:'white' , fontSize:18}}>27.99 $ /Monthly</Text>
        }  
        </View>
      </View>
      <View style={[styles.pricingcon,{marginTop:15}]}>
        ...
        {showchangeprice
        ? <Text style={{color:'white' , fontSize:18}}>20.99 $ /Monthly</Text>
      ...
      <View style={styles.pricingcon2}>
        ...
        {showchangeprice
        ? <Text style={{color:'white' , fontSize:18}}>40.99 $ /Monthly</Text>
        : <Text style={{color:'white' , fontSize:18}}>20.99 $ /Monthly</Text>
        }   
        </View>
      </View>
...
export default platinumpricing
